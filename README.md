...
- We go to our browser app and access the IP address for the homepage, which gives an overview of all of the functionality.
...
https://bit.ly/FrontierTrailCamFeedback
